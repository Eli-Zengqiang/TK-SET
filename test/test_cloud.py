...
#文件夹路径
fold1=r"C:\Users\ZHXR\Desktop\2.1data\testbd\全站仪数据\compare\0号楼/"
fold3=r"C:\Users\ZHXR\Desktop\2.1data\testbd\全站仪数据\compare\1楼/"
fold2=r"C:\Users\ZHXR\Desktop\2.1data\testbd\全站仪数据\compare\创新大厦2楼平台/"
...
for fold in folds:
	...
	for TS_file in TS_files:
		...
		print(TS_file+'('+str(round(scan_dist,1))+')最大绝对距离：'+str(np.abs(points_v_out).max())+';平均距离：'+str(points_v_out.mean())+';标准差：'+str(points_v_out.std()))#points_TS[:,3]
