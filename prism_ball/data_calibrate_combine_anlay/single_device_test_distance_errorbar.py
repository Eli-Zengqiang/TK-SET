...
def draw_distance_errorbar(datas_folders=None,total_data=None):
	""""
	...
	if total_data:
		...
		fold=r"C:\Users\ZHXR\Desktop\com_tool\2.1data\testbd\全站仪数据\compare/"
	fold1=fold+r'\0号楼/'   #r"C:\Users\ZHXR\Desktop\com_tool\2.1data\testbd\全站仪数据\compare\0号楼/"
	fold2=  fold+r'\创新大厦2楼平台/'  #r"C:\Users\ZHXR\Desktop\com_tool\2.1data\testbd\全站仪数据\compare\创新大厦2楼平台/"
	fold3= fold+r'\1楼/'     #r"C:\Users\ZHXR\Desktop\com_tool\2.1data\testbd\全站仪数据\compare\1楼/"
	fold4=fold+r'\眷诚斋/'    #r"C:\Users\ZHXR\Desktop\com_tool\2.1data\testbd\全站仪数据\compare\眷诚斋/"
...
if __name__=="__main__":
	datas_folders = [r"G:\TK-set\2.1data\20260807\b855\2026-08-07_10-21-01",
	                 r"G:\TK-set\2.1data\20260807\b855\2026-08-07_10-54-18",
	                 r"G:\TK-set\2.1data\20260807\b855\2026-08-07_11-14-15",
	                 r"G:\TK-set\2.1data\20260807\b855\2026-08-07_11-42-01"]

	#传参，并且会自动截图保存
	draw_distance_errorbar(datas_folders)

	#不传参数，则默认从全站仪标定的文件夹读取数据，此时不会保存图片
