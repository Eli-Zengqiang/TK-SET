...
class CfgClass:
    ...
    def __init__(self):
        ...
        #全站仪棱镜杆设计坐标
        self.PrismDesignPos_P0=["0.035","0.75","-0.123"]
        self.PrismDesignPos_P1=["0.055","-0.75","-0.13300"]

        #棱镜杆的棱镜球坐标
        self.PrismGeoPos_P0=["0.00000","0.00000","0.00000"]
        self.PrismGeoPos_P1 = ["0.00000", "0.00000", "0.00000"]
    ...
    def PrismGeoPoss(self,PrismGeoPos1,PrismGeoPos2):
        self.PrismGeoPos_P0[0]=PrismGeoPos1[1]
        self.PrismGeoPos_P0[1]=PrismGeoPos1[2]
        self.PrismGeoPos_P0[2]=PrismGeoPos1[3]
        self.PrismGeoPos_P1[0]= PrismGeoPos2[1]
        self.PrismGeoPos_P1[1] = PrismGeoPos2[2]
        self.PrismGeoPos_P1[2] = PrismGeoPos2[3]
